      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          ...
          <a
            ...
            className="btn-gradient px-12 py-7 rounded-full font-bold text-xl tracking-wide inline-flex items-center justify-center gap-3 min-w-[260px] shadow-lg"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="btn-outline px-12 py-7 rounded-full font-bold text-xl tracking-wide inline-flex items-center justify-center gap-3 min-w-[260px]"
          >
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
