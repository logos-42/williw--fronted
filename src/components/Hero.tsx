  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          <p className="text-lg md:text-xl text-white/45 leading-relaxed not-italic font-normal text-center max-w-xl">
            {t('hero.subtitle')}
          </p>
        </motion.div>
        ...
        >
          ...
          <a
            ...
            className="btn-gradient px-12 py-5 rounded-full font-bold text-lg tracking-wide inline-flex items-center justify-center gap-3 min-w-[260px] shadow-lg"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="btn-outline px-12 py-5 rounded-full font-bold text-lg tracking-wide inline-flex items-center justify-center gap-3 min-w-[260px]"
          >
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
